...
def new_hw(company='thorlabs',
    ...
    import_dev = f"from .{dev_file_name.strip('.py')} import {dev_class_name}"
    ...
    init_imports = f"from .{hw_file_name.strip('.py')} import {hw_class_name} \nfrom .{readout_file_name.strip('.py')} import {readout_class_name}"
    test_app_imports = f"from ScopeFoundryHW.{module_name.strip('.py')} import {hw_class_name}, {readout_class_name}"
