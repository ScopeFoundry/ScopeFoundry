...
from features.publish_to_gh_controller import PublishToGhController
from features.publish_to_gh_view import PublishToGhView
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.publish_to_gh_controller = PublishToGhController(
            PublishToGhView())
        self.tab_widget.addTab(
            self.publish_to_gh_controller.view, 'publish on GitHub')
