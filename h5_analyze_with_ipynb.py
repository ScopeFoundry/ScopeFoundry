...
def mk_cell_1_source(files_metadata) -> List[str]:
    ...
    lines = [
        "# CELL #0: AUTOGENERATED CELL: DO NOT ALTER THIS CELL, PROGRESS MAY BE LOST. use CELL #3 onwards",
        "import numpy as np",
        ...
        "## to move the h5 files mentioned in this folder to a subsfolder archived_data run the following line:",
        "# loaders.archive_unmentioned_h5_files(ignore_cells=(0, 1))"
...
def mk_cell_2_source(files_metadata: Dict) -> List[str]:
    return [
        "# CELL #1 ALTERNATIVE TO CELL #1. Only addition and commenting of lines are persistent",
