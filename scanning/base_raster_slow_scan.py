    ...
    def run(self):
        ...
        while not self.interrupt_measurement_called:        
            try:
                ...
                self.move_position_start(self.scan_h_positions[0], self.scan_v_positions[0], self.scan_z_positions[0])
                ...
                for self.pixel_i in range(self.Npixels):                
                    ...
                    h,v,z = self.scan_h_positions[i], self.scan_v_positions[i], self.scan_z_positions[i]
